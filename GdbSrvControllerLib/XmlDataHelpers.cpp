...
typedef struct
{
    ...
    WCHAR RegisterName[C_MAX_ATTR_LENGTH];              //  Name:The register抯 name; it must be unique within the target description.
    WCHAR RegistBitSize[C_MAX_ATTR_LENGTH];             //  Bitsize: The register抯 size, in bits.
    ...
    WCHAR RegisterType[C_MAX_ATTR_LENGTH];              //  Type: The type of the register.It may be a predefined type, a type defined in the current feature, or 
                                                        ...
                                                        //        and float is a floating point type(in the architecture抯 normal floating point format) of the 
